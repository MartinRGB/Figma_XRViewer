...
import { __private_allRegisteredObjects as allRegisteredObjects2 } from "@theatre/r3f";
...
import { Object3D, Raycaster, Vector3 as Vector32, Quaternion, Euler, Matrix4, Color, MeshBasicMaterial, DoubleSide, LineBasicMaterial, CylinderGeometry, BoxGeometry, BufferGeometry, Float32BufferAttribute, Mesh, Line, OctahedronGeometry, PlaneGeometry, TorusGeometry, SphereGeometry } from "three";
var TransformControls = class extends Object3D {
  constructor(camera, domElement) {
    ...
    _defineProperty(this, "tempVector", new Vector32());
    _defineProperty(this, "tempVector2", new Vector32());
    ...
    _defineProperty(this, "pointStart", new Vector32());
    _defineProperty(this, "pointEnd", new Vector32());
    _defineProperty(this, "offset", new Vector32());
    _defineProperty(this, "rotationAxis", new Vector32());
    _defineProperty(this, "startNorm", new Vector32());
    _defineProperty(this, "endNorm", new Vector32());
    _defineProperty(this, "rotationAngle", 0);
    _defineProperty(this, "cameraPosition", new Vector32());
    _defineProperty(this, "cameraQuaternion", new Quaternion());
    _defineProperty(this, "cameraScale", new Vector32());
    _defineProperty(this, "parentPosition", new Vector32());
    _defineProperty(this, "parentQuaternion", new Quaternion());
    _defineProperty(this, "parentQuaternionInv", new Quaternion());
    _defineProperty(this, "parentScale", new Vector32());
    _defineProperty(this, "worldPositionStart", new Vector32());
    _defineProperty(this, "worldQuaternionStart", new Quaternion());
    _defineProperty(this, "worldScaleStart", new Vector32());
    _defineProperty(this, "worldPosition", new Vector32());
    _defineProperty(this, "worldQuaternion", new Quaternion());
    _defineProperty(this, "worldQuaternionInv", new Quaternion());
    _defineProperty(this, "worldScale", new Vector32());
    _defineProperty(this, "eye", new Vector32());
    _defineProperty(this, "positionStart", new Vector32());
    _defineProperty(this, "quaternionStart", new Quaternion());
    _defineProperty(this, "scaleStart", new Vector32());
...
var TransformControlsGizmo = class extends Object3D {
  constructor() {
    ...
    _defineProperty(this, "tempVector", new Vector32(0, 0, 0));
    _defineProperty(this, "tempEuler", new Euler());
    _defineProperty(this, "alignVector", new Vector32(0, 1, 0));
    _defineProperty(this, "zeroVector", new Vector32(0, 0, 0));
    ...
    _defineProperty(this, "unitX", new Vector32(1, 0, 0));
    _defineProperty(this, "unitY", new Vector32(0, 1, 0));
    _defineProperty(this, "unitZ", new Vector32(0, 0, 1));
    _defineProperty(this, "gizmo", void 0);
...
var TransformControlsPlane = class extends Mesh {
  constructor() {
    ...
    _defineProperty(this, "unitZ", new Vector32(0, 0, 1));
    _defineProperty(this, "tempVector", new Vector32());
    _defineProperty(this, "dirVector", new Vector32());
    _defineProperty(this, "alignVector", new Vector32());
...
import studio3 from "@theatre/studio";
...
function useSelected() {
  ...
  (0, import_react3.useLayoutEffect)(() => {
    const setFromStudio = (selection) => {
      const item = selection.find((s2) => s2.type === "Theatre_SheetObject_PublicAPI" && allRegisteredObjects.has(s2));
      if (!item) {
        set(void 0);
      } else {
...
// ../react/src/index.ts
import { Box as Box2 } from "@theatre/dataverse";
...
function usePrism(fn, deps, debugLabel) {
  ...
  if (!boxRef.current) {
    boxRef.current = new Box2(fnAsCallback);
  } else {
    boxRef.current.set(fnAsCallback);
  }
  const derivation = (0, import_react4.useMemo)(() => prism(() => {
...
import studio2 from "@theatre/studio";
var sheet = void 0;
...
var editorSheetObjectConfig = {
  viewport: types.compound({
    ...
    shading: types.stringLiteral("rendered", {
      flat: "Flat",
      rendered: "Rendered",
      solid: "Solid",
      wireframe: "Wireframe"
    }, { as: "menu", label: "Shading" }),
    referenceWindow: types.stringLiteral("minimized", {
      maximized: "Maximized",
      minimized: "Minimized",
      hidden: "Hidden"
  ...
  transformControls: types.compound({
    mode: types.stringLiteral("translate", {
      translate: "Translate",
      rotate: "Rotate",
      scale: "Scale"
    }, { as: "switch", label: "Mode" }),
    space: types.stringLiteral("world", {
      local: "Local",
      world: "World"
...
function getEditorSheet() {
  if (!sheet) {
    sheet = studio2.getStudioProject().sheet("R3F UI");
  }
  return sheet;
}
...
var useExtensionStore = (0, import_zustand2.default)(____private_editorStore);
...
var EditableProxy = ({ storeKey, object }) => {
  ...
  (0, import_react9.useLayoutEffect)(() => {
    ...
    if (editable == null ? void 0 : editable.visibleOnlyInEditor) {
      object.visible = true;
    }
    return () => {
      object.visible = originalVisibility;
    };
  }, [editable == null ? void 0 : editable.visibleOnlyInEditor, object.visible]);
  const [hovered, setHovered] = (0, import_react9.useState)(false);
  const scene = useThree((state) => state.scene);
  const helper = (0, import_react9.useMemo)(() => {
    var _a2, _b;
    return (_b = editable == null ? void 0 : (_a2 = editable.objectConfig).createHelper) == null ? void 0 : _b.call(_a2, object);
  }, [object]);
  (0, import_react9.useEffect)(() => {
    if (helper == void 0) {
      return;
    ...
    onClick: (e2) => {
      if (e2.delta < 2) {
        ...
        if (!theatreObject) {
          ...
          studio3.setSelection([theatreObject]);
        }
      }
    },
...
import { MeshBasicMaterial as MeshBasicMaterial2, MeshPhongMaterial } from "three";
import studio4 from "@theatre/studio";
  ...
  (0, import_react12.useLayoutEffect)(() => {
    ...
    sceneProxy.traverse((object) => {
      if (object.userData.__editable) {
        ...
        if (editableProxies2[theatreKey] || !editables[theatreKey]) {
...
// src/extension/components/SnapshotEditor.tsx
import studio6 from "@theatre/studio";
...
var OrbitControlsImpl = class extends EventDispatcher {
  constructor(object, domElement) {
    super();
    __publicField(this, "object");
    __publicField(this, "domElement");
    __publicField(this, "enabled", true);
    __publicField(this, "target", new Vector33());
    ...
    this.zoom0 = this.object instanceof PerspectiveCamera3 ? this.object.zoom : 1;
    ...
    this.saveState = () => {
      ...
      scope.zoom0 = scope.object instanceof PerspectiveCamera3 ? scope.object.zoom : 1;
    };
    this.reset = () => {
      scope.target.copy(scope.target0);
      scope.object.position.copy(scope.position0);
      if (scope.object instanceof PerspectiveCamera3) {
    ...
    this.update = (() => {
      ...
      const quat = new Quaternion2().setFromUnitVectors(object.up, new Vector33(0, 1, 0));
      const quatInverse = quat.clone().invert();
      const lastPosition = new Vector33();
    ...
    const pan = (() => {
      ...
      return function pan2(deltaX, deltaY) {
        ...
        if (element && scope.object instanceof PerspectiveCamera3 && scope.object.isPerspectiveCamera) {
          const position = scope.object.position;
          offset.copy(position).sub(scope.target);
        ...
        } else if (element && scope.object instanceof OrthographicCamera2 && scope.object.isOrthographicCamera) {
    ...
    function dollyOut(dollyScale) {
      if (scope.object instanceof PerspectiveCamera3 && scope.object.isPerspectiveCamera) {
        scale /= dollyScale;
      } else if (scope.object instanceof OrthographicCamera2 && scope.object.isOrthographicCamera) {
...
// src/extension/components/useSnapshotEditorCamera.tsx
import studio5 from "@theatre/studio";
import { types as types2 } from "@theatre/core";
var camConf = {
  transform: {
    position: {
      x: types2.number(10),
  ...
  lens: {
    zoom: types2.number(1, { range: [1e-4, 10] }),
    fov: types2.number(50, { range: [1, 1e3] }),
    near: types2.number(0.1, { range: [0, Infinity] }),
    far: types2.number(2e3, { range: [0, Infinity] }),
    focus: types2.number(10, { range: [0, Infinity] }),
    filmGauge: types2.number(35, { range: [0, Infinity] }),
    filmOffset: types2.number(0, { range: [0, Infinity] })
  }
};
...
var InfiniteGridHelper = class extends Mesh2 {
  constructor({
    divisions = 10,
    scale = 0.1,
    color = new Color2("white"),
    distance = 8e3,
    subgridOpacity = 0.05,
    gridOpacity = 0.15
  } = {}) {
    const geometry = new PlaneGeometry2(2, 2, 1, 1);
...
var SnapshotEditor = (props) => {
  ...
  const onPointerMissed = (0, import_react20.useCallback)(() => {
    const obj = studio6.selection.find((sheetOrObject) => allRegisteredObjects2.has(sheetOrObject));
    if (obj) {
      studio6.setSelection([obj.sheet]);
    }
  }, []);
  ...
  (0, import_react20.useEffect)(() => {
    if (!toolsContainer)
      return;
    return studio6.ui.renderToolset("snapshot-editor", toolsContainer);
  }, [toolsContainer]);
  if (!editorObject)
...
import { prism as prism2, Ticker, val as val2 } from "@theatre/dataverse";
  ...
  toolbars: {
    ...
    "snapshot-editor": (set, studio7) => {
      ...
      const calc = prism2(() => {
        var _a, _b, _c;
        const editorObject = getEditorSheetObject();
        const transformControlsMode = (_a = val2(editorObject == null ? void 0 : editorObject.props.transformControls.mode)) != null ? _a : "translate";
        const transformControlsSpace = (_b = val2(editorObject == null ? void 0 : editorObject.props.transformControls.space)) != null ? _b : "world";
        const viewportShading = (_c = val2(editorObject == null ? void 0 : editorObject.props.viewport.shading)) != null ? _c : "rendered";
        return [
          {
            type: "Icon",
