...
var useExtensionStore = (0, import_zustand.default)(____private_editorStore);
  ...
  toolbars: {
    "snapshot-editor": (set, studio2) => {
      ...
      const calc = prism(() => {
        ...
        const transformControlsMode = (_a = val(editorObject == null ? void 0 : editorObject.props.transformControls.mode)) != null ? _a : "translate";
        const transformControlsSpace = (_b = val(editorObject == null ? void 0 : editorObject.props.transformControls.space)) != null ? _b : "world";
        const viewportShading = (_c = val(editorObject == null ? void 0 : editorObject.props.viewport.shading)) != null ? _c : "rendered";
        return [
          {
            type: "Icon",
