...
function getEditorSheet() {
  if (!sheet) {
    sheet = import_studio.default.getStudioProject().sheet("R3F UI");
  }
  return sheet;
}
...
var useExtensionStore = (0, import_zustand.default)(import_r3f.____private_editorStore);
...
var r3fExtension = {
  id: "@theatre/r3f",
  toolbars: {
    "snapshot-editor": (set, studio2) => {
      const { createSnapshot } = useExtensionStore_default.getState();
      const calc = (0, import_dataverse.prism)(() => {
        var _a, _b, _c;
        const editorObject = getEditorSheetObject();
        const transformControlsMode = (_a = (0, import_dataverse.val)(editorObject == null ? void 0 : editorObject.props.transformControls.mode)) != null ? _a : "translate";
        const transformControlsSpace = (_b = (0, import_dataverse.val)(editorObject == null ? void 0 : editorObject.props.transformControls.space)) != null ? _b : "world";
        const viewportShading = (_c = (0, import_dataverse.val)(editorObject == null ? void 0 : editorObject.props.viewport.shading)) != null ? _c : "rendered";
        return [
          {
            type: "Icon",
          ...
          },
          {
            ...
            onChange: (value) => studio2.transaction(({ set: set2 }) => set2(editorObject.props.transformControls.mode, value)),
            options: [
              {
                value: "translate",
          ...
          },
          {
            ...
            onChange: (space) => studio2.transaction(({ set: set2 }) => {
          ...
          },
          {
            ...
            onChange: (shading) => studio2.transaction(({ set: set2 }) => {
      ...
      return calc.tapImmediate(import_dataverse.Ticker.raf, () => {
        set(calc.getValue());
      });
    }
  }
