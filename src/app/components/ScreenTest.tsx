...
import {OrbitControls, useGLTF,useVideoTexture,useTexture} from '@react-three/drei'
...
import TextureAreaLightScreenEffects from './AreaLightDemo/TextureAreaLightScreenEffects'
import { link } from 'fs'
    ...
    <group position={position} rotation={rotation}>
      <mesh>
        ...
        <textureAreaLight
          ...
          isRouhnessControllable={lightRoughnessControllable}
          renderer={gl}
        ></textureAreaLight>
    </group>
  </>
...
const ModifiedTextureAreaLight = ({}) =>{
  ...
  const { lightColor, lightIntensity, lightRoughnessControllable,lightRoughness,lightWidth,lightHeight,lightTexture,position,rotation,position2,rotation2,ambientIntensity } = useControls({ 
    ...
    lightWidth:{value:screenWidth,step:1},
    lightHeight:{value:screenHeight,step:1},
    ...
    rotation:{value:[0.4,0,-Math.PI/2],step:0.01},
    position2:{value:[719,0,-540],step:1},
    rotation2:{value:[0,0,0]},
    ambientIntensity:{value:0.01,step:0.1}
  })
